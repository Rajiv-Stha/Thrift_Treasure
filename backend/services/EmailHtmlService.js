...
class EmailHtmlService{
    ...
    getEmalConfirmationHtml(confirmationHash){
        ...
        <h1 style="color:#0e0b3d" > Thrift Treasure  </h1> </br>
           <h1 style="color:#0e0b3d" > Confirm your email to continue to ThrifTrazzer   </h1> </br>
       <h4 style="color:#0e0b3d"> You are closer to be the part of Thriftrazzer .  </h4> </br> 
